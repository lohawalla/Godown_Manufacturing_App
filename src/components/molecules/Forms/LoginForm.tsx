        ...
        return (
          <View style={styles.toastContainer} key={toastId}>
            <VStack space="xs">
              ...
              <ToastDescription color="white">{message}</ToastDescription>
            </VStack>
            <Pressable
              style={{top: 0, right: 0, position: 'absolute', padding: 8}}
              mt="$1"
      ...
      <BlurView
        ...
        <Formik
          ...
          onSubmit={(values, formikHelpers) =>
            handleState(values, formikHelpers)
          }>
            ...
            <FormControl
              ...
              <View>
                <View style={{marginTop: 20}}>
                  <Text style={{marginLeft: '12%'}} color="#475569" size="md">
                    Employee Id
                  </Text>
                  {errors.email && (
